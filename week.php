...
<div class="container-fluid">
            <div class="row-fluid">
                <div style="position: fixed; width: 14%; float: right; padding-top: 0; padding-left: 2%;">
                    ...
                    <!--<div style="z-index: 999; margin-top: 50px;">
                    ...
                    <div id="month" style="width: 100%; float: right; margin-top: 10px; margin-right: 10%;"></div>
                </div>
                <!--/span-->
                            ...
                            <div class="block-content collapse in">
                                ...
                                -->
                                    <div style="width: 100%; float: left;">
                                        <div id="calendar<?php echo $room; ?>" style="margin: 10px 20px;"></div>
                                    </div>
                            </div>
                        </div>
                        <!-- /block -->
        ...
        </div><input type="button" id="bt" value="123"><input type="button" id="bt2" value="456">

<p id="stat"><script type="text/javascript" src="/js/tongji.js"></script></p>
<script type="text/javascript">
CreatCalendar('<?php echo $room; ?>', 'prev,next today', 'title', '', 'agendaWeek');
$(function(){
